...
export const LOADING_BAR_UPDATE = 'LOADING_BAR_UPDATE';

// Invitation link 
export const SET_INVITATION_LINK = 'SET_INVITATION_LINK';
export const CLEAR_INVITATION_LINK = 'CLEAR_INVITATION_LINK';
...
export const REQUEST_DOWNLOAD_FILES = 'REQUEST_DOWNLOAD_FILES';
...
export const SAVE_TEXT_FOR_EXERCISE = 'SAVE_TEXT_FOR_EXERCISE';
export const CLEAR_TEXT_FOR_EXERCISE = 'CLEAR_TEXT_FOR_EXERCISE';
...
export const TRANSITIONS_STATE = 'TRANSITIONS_STATE';
...
export const UPDATE_PERSONAL_NOTES = 'UPDATE_PERSONAL_NOTES';
export const CLEAR_PERSONAL_NOTES = 'CLEAR_PERSONAL_NOTES';
...
// Upload
export const UPLOAD_FILE_EXERCISE = 'UPLOAD_FILE_EXERCISE';
